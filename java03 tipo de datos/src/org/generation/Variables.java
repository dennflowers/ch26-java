...
public class Variables {
	...
	public static void main(String[] args) {
		 ...
		 * - Puedes utilzar cualquier caracter Unicode
		 * - La variable puede comenzar:
		 *   > una letra ej. miVariable
		 *   > signo de dolar $miVariable
		 *   > caracter subrayado _miVariable
		 * 
		 */
		
		int $myVar; // es válido, pero no es recomendable
		int _myVar; // es válida, pero no es recomendable
		//int #myVar; // no es válido
		int myVarEspañol; // es válido, pero no se recomienda, de preferencia nombres en inglés.
		 ...
		 * Variables de instancias (Non static fields): atributos de los objetos.
		 * Variables de clase (Static Fields): atributos de la clase.
		 * Variables locales (local variable): variable dentro de las funciones(métodos)
		...
		*/
		...
		// El tipo de byte es de 8 bits, almacena datos númericos enteros.
			byte myVarByte = 12;
		...
		// El tipo short es de 16 bits, almacena datos númericos enteros.
		// 2^16 = 65536
		...
		// El tipo int es de 32 bits, almacena datos númericos enteros.
		// 2^32 = 2147483647
			int myVarInt = 1000;
		...
		// El tipo long es de 64 bits, almacena datos númericos enteros.
		// 2^64
			long myVarLong = 1500;
		...
		// Para indicar una literal numércia de tipo float, hay que indicar
		// La literal con la letra f.	
		
		// El tipo double es de 64 bits, almancea datos de punto flotante
		...
		// El tipo char solo almacena una caracter, se debe definir la literal
		...
		// Para las literales numérica se puede usar el guión bajo_ para separar números
		// No se peude escribir _ al inicio o final de la literal
        ...
        // \" (double quote), \' (single quote), and \\ (backslash). 
		   ...
		   System.out.print("Mensaje string: " + myVarString);
		...
		// Obteniendo el primer caracter de un String.
		   System.out.println("El primer caracter de " + edadString + " es : " + edadString.charAt(1));
